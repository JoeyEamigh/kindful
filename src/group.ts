...
export async function createWithContact<T extends string[]>(data: ContactWithGroup<T>[], groups: T) {
  return await Kindful.api.post<CreateGroupRequest<T>, ImportResponse>('/api/v1/imports', {
    data_format: 'contact',
    data_type: 'json',
    action_type: 'create',
    match_by: { group: 'name' },
